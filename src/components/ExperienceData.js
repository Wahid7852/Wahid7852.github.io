const ExperienceData = [
  {
    ...
    responsibility: [
      `Ensuring the team conducts bespoke campaigns based on clients’ requirements to ensure client satisfaction.`,
      ...
      `Managing training syllabus for new recruits & holding training personally.`,
      `Ensure the team acknowledges and acts to resolve all client complaints.`,
      `Report team performance each week to the company Director.`,
